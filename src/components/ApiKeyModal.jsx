      ...
      >
          ...
          <div style={{ display: 'flex', gap: '0.75rem', alignItems: 'center' }}>
            ...
            <div>
              ...
              <p style={{ fontSize: '0.78rem', color: '#4b5563', marginTop: 2 }}>
                Used only for this session — never stored on any server
              </p>
            </div>
          </div>
        ...
        <div style={{
          ...
          <p style={{ fontSize: '0.75rem', color: '#6b7280', lineHeight: 1.5 }}>
            Your key is stored only in <strong style={{ color: '#94a3b8' }}>sessionStorage</strong> — 
            it disappears when you close this tab. The receipt image is sent directly from your browser 
            to Google's servers and is not stored.
          </p>
        </div>
